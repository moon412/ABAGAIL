...
public class ContinuousPeaksOpt {
    ...
    public static void main(String[] args) {
		int[] iters = {10, 100, 500, 1000, 2000, 3000, 4000, 5000, 8000, 10000};
		int n_rounds = 3;
		double start_time = 0;
		double end_time = 0;
		...
		write_output_to_file("/Users/yuezha01/projects/ml7641_2018/", "results_continuous.txt", results.toString(), true);
		write_output_to_file("/Users/yuezha01/projects/ml7641_2018/", "time_continuous.txt", time.toString(), true);
    }
}

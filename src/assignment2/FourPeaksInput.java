...
public class FourPeaksInput {
    ...
    public static void main(String[] args) {
		int[] inputs = {10, 50, 100, 200, 400, 800};
		int n_rounds = 3;
		double start_time = 0;
		double end_time = 0;
		...
		write_output_to_file("/Users/yuezha01/projects/ml7641_2018/", "results_4peaks_inputs.txt", results.toString(), true);
		write_output_to_file("/Users/yuezha01/projects/ml7641_2018/", "time_4pearks_inputs.txt", time.toString(), true);
    }
}
